...
public class Main implements ModInitializer {
	...
	public static final StatisticKey<Integer> ROUNDS_SURVIVED = StatisticKey.intKey(ROUNDS_SURVIVED_ID, StatisticKey.StorageType.TOTAL);

	private static final Identifier PLAYERS_PUNCHED_ID = new Identifier(MOD_ID, "players_punched");
	public static final StatisticKey<Integer> PLAYERS_PUNCHED = StatisticKey.intKey(PLAYERS_PUNCHED_ID, StatisticKey.StorageType.TOTAL);
